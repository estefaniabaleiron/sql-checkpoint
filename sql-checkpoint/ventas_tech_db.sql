-- ============================================================
-- PROYECTO: Ventas_Tech_DB (Pre-entrega 3)
-- AUTOR: Estefanía Baleiron
-- DESCRIPCIÓN: Script de creación de base de datos, esquema DDL,
--              restricciones de integridad referencial y carga DML.
-- ============================================================
...
-- ============================================================
-- 1. DROP TABLES (Orden inverso a las dependencias de FK)
-- ============================================================
...
-- ============================================================
-- 2. CREATE TABLES & CONSTRAINTS (DDL)
-- ============================================================

-- Tabla: Categorías (Dimensión independiente)
...
-- Tabla: Clientes (Dimensión independiente)
...
-- Tabla: Productos (Dimensión dependiente de Categorías)
...
-- Tabla: Ventas (Tabla de hechos central dependiente de Clientes y Productos)
CREATE TABLE ventas (
